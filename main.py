...
def registrar_prestamo(usuarios, inventario):
    ...
    while True:
        ...
        if not titulo_libro:
            break
        libro = next((lib for lib in inventario.lista_de_libros if lib.titulo == titulo_libro), None)
        ...
        if libros:
            ...
            print("No se ha podido registrar el libro")
